...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Coche coche1 = new Coche(1,"Relámpago", 200, 9, 8, 200, 100, "Mario");
        Coche coche2 = new Coche(2,"Snake", 150, 8, 8, 200, 100, "Colapinto");
        Coche coche3 = new Coche(3,"Tanque",160, 10, 7, 200, 100, "Verstappen");
        Circuito circuito1= new Circuito(1,"Circuito 1",500,3,5,"Soleado",1);
